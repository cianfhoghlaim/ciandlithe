# dlt_sources/law/jersey — Jersey legal DLT sources
...
`/Users/cianmacandeisigh/dev/cianfhoghlaim/dlt_sources/law/jersey/british_isles/legislation.py`
...
- `__init__.py` — 1-line re-export of `jersey_law_source`.
- `_factory.py` — `JurisdictionPipelineBase` subclass with
  `STAGE = "law"`; exposes `jersey_law_source` binding.
...
`dlt_sources/_sister_refs/ciandlithe/law/jersey/<file>`.