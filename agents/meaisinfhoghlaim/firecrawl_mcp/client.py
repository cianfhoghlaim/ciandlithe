...
class FirecrawlMCPClient:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            provider_router: The ciandlithe 4-tier ModelProviderRouter
                (per the ciandlithe-repo-foundation-v1 spec +
                ciandlithe-agentic-interaction-v1 spec). When set,
    ...
    def agent(
        ...
        *,
        ...
        Per the ciandlithe 4-tier ModelProviderRouter (Unsloth Studio
        ...
        every other ciandlithe BAML extraction. When None, falls
    ...
    def _resolve_llm_model(self, default_model: str = "spark-1-mini") -> str:
        ...
        When the ciandlithe 4-tier ModelProviderRouter is set, the
