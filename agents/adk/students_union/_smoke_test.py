"""ciandlithe — Smoke test for the 5 SU tools + 5 ADK agents.
...
Run from the cianchosaint/.venv (which has google-adk 2.9.0 installed):
    ...
    /Users/cianmacandeisigh/dev/cianchosaint/.venv/bin/python3 \\
        /Users/cianmacandeisigh/dev/ciandlithe/agents/adk/students_union/_smoke_test.py
...
REPO_ROOT = THIS_DIR.parent.parent.parent  # ciandlithe/agents/adk/students_union → ciandlithe
